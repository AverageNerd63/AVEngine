...
#define AV_PI 3.14159265358979323846f
#define AV_PI_2 2.0f * AV_PI
#define AV_HALF_PI 0.5f * AV_PI
#define AV_QUARTER_PI 0.25f * AV_PI
#define AV_ONE_OVER_PI 1.0f / AV_PI
#define AV_ONE_OVER_TWO_PI 1.0f / AV_PI_2
#define AV_SQRT_TWO 1.41421356237309504880f
#define AV_SQRT_THREE 1.73205080756887729352f
#define AV_SQRT_ONE_OVER_TWO 0.70710678118654752440f
#define AV_SQRT_ONE_OVER_THREE 0.57735026918962576450f
#define AV_DEG2RAD_MULTIPLIER AV_PI / 180.0f
#define AV_RAD2DEG_MULTIPLIER 180.0f / AV_PI

// The multiplier to convert seconds to milliseconds.
#define AV_SEC_TO_MS_MULTIPLIER 1000.0f

// The multiplier to convert milliseconds to seconds.
#define AV_MS_TO_SEC_MULTIPLIER 0.001f

// A huge number that should be larger than any valid number used.
#define AV_INFINITY 1e30f

// Smallest positive number where 1.0 + FLOAT_EPSILON != 0
#define AV_FLOAT_EPSILON 1.192092896e-07f

// ------------------------------------------
// General math functions
// ------------------------------------------
AVAPI f32 ksin(f32 x);
AVAPI f32 kcos(f32 x);
AVAPI f32 ktan(f32 x);
AVAPI f32 kacos(f32 x);
AVAPI f32 ksqrt(f32 x);
AVAPI f32 kabs(f32 x);
 ...
 */
AVINLINE b8 is_power_of_2(u64 value) {
    return (value != 0) && ((value & (value - 1)) == 0);
}

AVAPI i32 krandom();
AVAPI i32 krandom_in_range(i32 min, i32 max);

AVAPI f32 avkrandom();
AVAPI f32 avkrandom_in_range(f32 min, f32 max);
 ...
 */
AVINLINE vec2 vec2_create(f32 x, f32 y) {
    vec2 out_vector;
    out_vector.x = x;
    out_vector.y = y;
    return out_vector;
 ...
 */
AVINLINE vec2 vec2_add(vec2 vector_0, vec2 vector_1) {
    return (vec2){
 ...
 * @return The resulting vector. 
 */
AVINLINE vec2 vec2_sub(vec2 vector_0, vec2 vector_1) {
    return (vec2){
        vector_0.x - vector_1.x,
        vector_0.y - vector_1.y};
}
 ...
 * @return The resulting vector. 
 */
AVINLINE vec2 vec2_mul(vec2 vector_0, vec2 vector_1) {
    return (vec2){
        vector_0.x * vector_1.x,
        vector_0.y * vector_1.y};
}
 ...
 * @return The resulting vector. 
 */
AVINLINE vec2 vec2_div(vec2 vector_0, vec2 vector_1) {
    return (vec2){
        vector_0.x / vector_1.x,
        vector_0.y / vector_1.y};
}
 ...
 */
AVINLINE f32 vec2_length_squared(vec2 vector) {
 ...
 * @return The length.
 */
AVINLINE f32 vec2_length(vec2 vector) {
 ...
 */
AVINLINE void vec2_normalize(vec2* vector) {
 ...
 */
AVINLINE vec2 vec2_normalized(vec2 vector) {
 ...
 */
AVINLINE b8 vec2_compare(vec2 vector_0, vec2 vector_1, f32 tolerance) {
 ...
 */
AVINLINE f32 vec2_distance(vec2 vector_0, vec2 vector_1) {
    vec2 d = (vec2){
        vector_0.x - vector_1.x,
        vector_0.y - vector_1.y};
 ...
 */
AVINLINE vec3 vec3_create(f32 x, f32 y, f32 z) {
    return (vec3){x, y, z};
}
 ...
 * @return A new vec3 
 */
AVINLINE vec3 vec3_from_vec4(vec4 vector) {
 ...
 * @return A new vec4 
 */
AVINLINE vec4 vec3_to_vec4(vec3 vector, f32 w) {
 ...
 * @return The resulting vector. 
 */
AVINLINE vec3 vec3_add(vec3 vector_0, vec3 vector_1) {
    return (vec3){
        vector_0.x + vector_1.x,
        vector_0.y + vector_1.y,
 ...
 * @return The resulting vector. 
 */
AVINLINE vec3 vec3_sub(vec3 vector_0, vec3 vector_1) {
    return (vec3){
        vector_0.x - vector_1.x,
        vector_0.y - vector_1.y,
        vector_0.z - vector_1.z};
 ...
 * @return The resulting vector. 
 */
AVINLINE vec3 vec3_mul(vec3 vector_0, vec3 vector_1) {
    return (vec3){
        vector_0.x * vector_1.x,
        vector_0.y * vector_1.y,
        vector_0.z * vector_1.z};
 ...
 */
AVINLINE vec3 vec3_mul_scalar(vec3 vector_0, f32 scalar) {
    return (vec3){
        vector_0.x * scalar,
        vector_0.y * scalar,
        vector_0.z * scalar};
 ...
 * @return The resulting vector. 
 */
AVINLINE vec3 vec3_div(vec3 vector_0, vec3 vector_1) {
    return (vec3){
        vector_0.x / vector_1.x,
        vector_0.y / vector_1.y,
        vector_0.z / vector_1.z};
 ...
 * @return The squared length.
 */
AVINLINE f32 vec3_length_squared(vec3 vector) {
 ...
 * @return The length.
 */
AVINLINE f32 vec3_length(vec3 vector) {
 ...
 * @param vector A pointer to the vector to be normalized.
 */
AVINLINE void vec3_normalize(vec3* vector) {
 ...
 * @return A normalized copy of the supplied vector 
 */
AVINLINE vec3 vec3_normalized(vec3 vector) {
 ...
 */
AVINLINE f32 vec3_dot(vec3 vector_0, vec3 vector_1) {
    f32 p = 0;
 ...
 */
AVINLINE vec3 vec3_cross(vec3 vector_0, vec3 vector_1) {
    return (vec3){
 ...
 * @return True if within tolerance; otherwise false. 
 */
AVINLINE const b8 vec3_compare(vec3 vector_0, vec3 vector_1, f32 tolerance) {
    if (kabs(vector_0.x - vector_1.x) > tolerance) {
        return FALSE;
    }
 ...
 * @return The distance between vector_0 and vector_1.
 */
AVINLINE f32 vec3_distance(vec3 vector_0, vec3 vector_1) {
    vec3 d = (vec3){
        vector_0.x - vector_1.x,
        vector_0.y - vector_1.y,
        vector_0.z - vector_1.z};
 ...
 */
AVINLINE vec4 vec4_create(f32 x, f32 y, f32 z, f32 w) {
    vec4 out_vector;
 ...
 * @return A new vec3 
 */
AVINLINE vec3 vec4_to_vec3(vec4 vector) {
    return (vec3){vector.x, vector.y, vector.z};
}
 ...
 * @return A new vec4 
 */
AVINLINE vec4 vec4_from_vec3(vec3 vector, f32 w) {
#if defined(KUSE_SIMD)
    vec4 out_vector;
    out_vector.data = _mm_setr_ps(x, y, z, w);
    return out_vector;
 ...
 * @return The resulting vector. 
 */
AVINLINE vec4 vec4_add(vec4 vector_0, vec4 vector_1) {
    vec4 result;
     for (u64 i = 0; i < 4; ++i) {
 ...
 * @return The resulting vector. 
 */
AVINLINE vec4 vec4_sub(vec4 vector_0, vec4 vector_1) {
    vec4 result;
    for (u64 i = 0; i < 4; ++i) {
        result.elements[i] = vector_0.elements[i] - vector_1.elements[i];
    }
 ...
 * @return The resulting vector. 
 */
AVINLINE vec4 vec4_mul(vec4 vector_0, vec4 vector_1) {
    vec4 result;
    for (u64 i = 0; i < 4; ++i) {
        result.elements[i] = vector_0.elements[i] * vector_1.elements[i];
    }
 ...
 * @return The resulting vector. 
 */
AVINLINE vec4 vec4_div(vec4 vector_0, vec4 vector_1) {
    vec4 result;
    for (u64 i = 0; i < 4; ++i) {
        result.elements[i] = vector_0.elements[i] / vector_1.elements[i];
    }
 ...
 * @return The squared length.
 */
AVINLINE f32 vec4_length_squared(vec4 vector) {
 ...
 * @return The length.
 */
AVINLINE f32 vec4_length(vec4 vector) {
 ...
 * @param vector A pointer to the vector to be normalized.
 */
AVINLINE void vec4_normalize(vec4* vector) {
 ...
 * @return A normalized copy of the supplied vector 
 */
AVINLINE vec4 vec4_normalized(vec4 vector) {
    vec4_normalize(&vector);
    return vector;
}

AVINLINE f32 vec4_dot_f32(
